  ...
  return (
    <div className='min-h-screen bg-gray-100 flex flex-col justify-center items-center px-4 text-center relative overflow-hidden'
      >
          ...
          <Link to='/my-orders' className='mt-4 text-[#ff4d2d] font-semibold hover:underline'>View My Orders</Link>
          <div className='absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-white opacity-35 pointer-events-none'></div>
