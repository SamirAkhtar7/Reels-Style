            ...
            <div className="w-full max-w-lg bg-white/80 dark:bg-slate-800/70 backdrop-blur-sm border border-gray-100 dark:border-slate-700 rounded-2xl shadow-lg p-6">
                ...
                {step === 1 && (
                    <section aria-labelledby="send-otp" className="space-y-4">
                        <label htmlFor="fp-email" className="block text-sm font-medium text-slate-700 dark:text-slate-200">
                            Email
                        </label>
                        <input
                            id="fp-email"
                        ...
                        />
                        <div id="fp-email-desc" className="text-xs text-slate-500">We will send an OTP to this email.</div>
                        ...
                        <div className="mt-4 flex gap-3">
                            ...
                            <button type="button" onClick={goBack} className="px-4 py-3 rounded-lg border border-gray-200">
                                Cancel
                            </button>
                        </div>
                    </section>
                ...
                {step === 2 && (
                    <section aria-labelledby="verify-otp" className="space-y-4">
                        <label htmlFor="fp-otp" className="block text-sm font-medium text-slate-700 dark:text-slate-200">
                            OTP
                        </label>
                        <input
                            id="fp-otp"
                        ...
                        <div className="mt-4 flex gap-3">
                            ...
                            <button type="button" onClick={() => setStep(1)} className="px-4 py-3 rounded-lg border border-gray-200">
                                Back
                            </button>
                        </div>
                    </section>
                ...
                {step === 3 && (
                    <section aria-labelledby="reset-password" className="space-y-4">
                        <label htmlFor="fp-password" className="block text-sm font-medium text-slate-700 dark:text-slate-200">
                            New Password
                        </label>
                        <input
                            id="fp-password"
                        ...
                        <label htmlFor="fp-confirm" className="block text-sm font-medium text-slate-700 dark:text-slate-200">
                            Confirm Password
                        </label>
                        <input
                            id="fp-confirm"
                        ...
                        /> <div className="mt-4 flex gap-3">
                            ...
                            <button type="button" onClick={() => setStep(2)} className="px-4 py-3 rounded-lg border border-gray-200">
                                Back
                            </button>
                        </div>
                    </section>
