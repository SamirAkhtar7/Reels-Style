...
router.post( "/update-order-status/:orderId/:shopId",
  authMiddleware.authUserMiddleware,
  orderController.updateOrderStatus
);
// New route to get available delivery
router.get("/get-assigned-orders",
  authMiddleware.authUserMiddleware,
  orderController.getDeliveryBoyAssignment
);
// New route to accept order
router.get( "/accept-order/:assignmentId",
  authMiddleware.authUserMiddleware,
...
router.get("/get-order-by-id/:orderId",
  authMiddleware.authUserMiddleware,
...
router.post("/verify-delivery-otp",
  authMiddleware.authUserMiddleware,orderController.verifyDeliveryOtp);
// New route to verify payment
router.post("/verify-payment",
  authMiddleware.authUserMiddleware,orderController.verifyPayment);
